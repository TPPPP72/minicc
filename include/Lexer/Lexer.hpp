...
private:
    ...
    std::array<std::string_view, 14> keywords{"char"sv, "short"sv, "int"sv, "long"sv, "float"sv, "double"sv, "main"sv, "if"sv, "while"sv, "for"sv, "return"sv, "sizeof"sv, "struct"sv, "union"sv};
    std::string m_source;
